...
public class scoresAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        if (config.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL) {
            isRTL = true;
            mItem = LayoutInflater.from(context).inflate(R.layout.scores_list_item_ltr, parent, false);
        } else {
            isRTL = false;
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        //Log.e("Gent", cursor.getString(COL_HOME) + " Vs. " + cursor.getString(COL_MATCHTIME) + " id " + Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
